...
const Search: React.FunctionComponent<ISearchProps> = () => {
  ...
  function changeRoadTrip(){
    ...
    return (
        <div>
            <Buttons>
                <div className={toggleClass ? 'type-button active' : 'type-button'}><button onClick={changeOneWay}>One place</button></div>
                <div className={toggleClass ? 'type-button' : 'type-button active'}><button onClick={changeRoadTrip}>Road trip</button></div>
            </Buttons>
